...
# Configure with 10-minute read timeout (refinement can take time with large lectures)
# Lambda timeout is 10 minutes (600s), so this gives full time for complex refinement
bedrock_config = Config(
    read_timeout=600,  # 10 minutes (refinement step can take 5-8 minutes for complex lectures)
    connect_timeout=10,
